...
app.post('/api/productos', verifivarToken, async (req, res) => {
  try {
...
app.put('/api/productos/:id', verifivarToken, async (req, res) => {
  try {
...
app.delete('/api/productos/:id', verifivarToken, async (req, res) => {
  try {
